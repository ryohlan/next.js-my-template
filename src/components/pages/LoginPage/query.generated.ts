...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'LoginOutput', success: boolean, AuthenticationResult: { __typename?: 'AuthenticationResult', AccessToken: string, ExpiresIn: number, RefreshToken?: string | null | undefined, TokenType: string } } };
