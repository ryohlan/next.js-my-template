...
export type VerifyPincodeMutationVariables = Types.Exact<{
  confirmInput: Types.ConfirmInput;
}>;


export type VerifyPincodeMutation = { __typename?: 'Mutation', confirm: { __typename?: 'ConfirmOutput', success: boolean } };


export const VerifyPincodeDocument = gql`
    mutation verifyPincode($confirmInput: ConfirmInput!) {
  confirm(input: $confirmInput) {
    success
  }
}
    `;
export type VerifyPincodeMutationFn = Apollo.MutationFunction<VerifyPincodeMutation, VerifyPincodeMutationVariables>;

/**
 * __useVerifyPincodeMutation__
 *
 * To run a mutation, you first call `useVerifyPincodeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useVerifyPincodeMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [verifyPincodeMutation, { data, loading, error }] = useVerifyPincodeMutation({
 *   variables: {
 *      confirmInput: // value for 'confirmInput'
 *   },
 * });
 */
export function useVerifyPincodeMutation(baseOptions?: Apollo.MutationHookOptions<VerifyPincodeMutation, VerifyPincodeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<VerifyPincodeMutation, VerifyPincodeMutationVariables>(VerifyPincodeDocument, options);
      }
export type VerifyPincodeMutationHookResult = ReturnType<typeof useVerifyPincodeMutation>;
export type VerifyPincodeMutationResult = Apollo.MutationResult<VerifyPincodeMutation>;
export type VerifyPincodeMutationOptions = Apollo.BaseMutationOptions<VerifyPincodeMutation, VerifyPincodeMutationVariables>;